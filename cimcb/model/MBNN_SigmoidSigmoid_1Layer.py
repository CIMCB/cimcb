...
class MBNN_SigmoidSigmoid_1Layer(BaseModel):
    """2 Layer logistic-logistic neural network using Keras"""

    parametric = True
    bootlist = None

    def __init__(self, n_neurons_l1=2, n_neurons_l2=1, epochs=200, learning_rate=0.01, momentum=0.0, decay=0.0, nesterov=False, loss="binary_crossentropy", batch_size=None, verbose=0):
        ...
        self.__name__ = 'cimcb.model.MBNN_SigmoidSigmoid_1Layer'
