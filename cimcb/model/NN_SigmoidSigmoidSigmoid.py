...
class NN_SigmoidSigmoidSigmoid(BaseModel):
    ...
    def __init__(self, n_neurons_l1=2, n_neurons_l2=2, epochs=200, learning_rate=0.01, momentum=0.0, decay=0.0, nesterov=False, loss="binary_crossentropy", batch_size=None, verbose=0):
        ...
        self.__name__ = 'cimcb.model.NN_SigmoidSigmoidSigmoid'
    ...
    def train(self, X, Y, epoch_ypred=False, epoch_xtest=None):
        ...
        self.model.add(Dense(self.n_neurons_l1, activation="sigmoid", input_dim=len(X.T)))
        self.model.add(Dense(self.n_neurons_l2, activation="sigmoid", input_dim=self.n_neurons_l1))
